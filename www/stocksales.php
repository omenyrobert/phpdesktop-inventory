...
if(isset($_GET['from_date'])&&isset($_GET['to_date']))
{
   ...
   $query=$conn->query("SELECT *,  SUM(sqty) FROM  `stockIn` INNER JOIN `stockOut` ON `stockOut`.sitem = `stockIn`.item WHERE ddate BETWEEN '$from_date' AND '$to_date' AND ttype='stock' GROUP BY sitem") or die("Failed to fetch row!");
